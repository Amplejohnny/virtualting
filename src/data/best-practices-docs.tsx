...
export const bestPracticesSections: SectionType[] = [
  {
    ...
    content: (
      <>
        ...
        <p className="mt-3 ml-3 md:ml-6">As a talent, you can manage your time slots effectively by:</p>

        <SubTopic id="slot-discipline">1. Maintain Slot Discipline</SubTopic>
        <ul className="list-disc md:list-none md:ml-10 ml-6 mt-3 space-y-2">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-3 ml-3 md:ml-6">Your communication with talents is key to success:</p>
