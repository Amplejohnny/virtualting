...
export const resourcesSections: SectionType[] = [
  {
    ...
    content: (
      <>
        ...
        <p>
          <span className="ml-4 font-bold">2. How does Virtualting work?</span>
        </p>
        <p className="ml-10">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="ml-4 font-bold">Performance Score</p>
        <p className="ml-10">
        ...
        <p className="ml-4 font-bold">Promotion Level</p>
        <p className="ml-10">
        ...
        <p className="ml-4 font-bold">trust Score</p>
        <p className="ml-10">
        ...
        <p className="ml-4 font-bold">Wallet</p>
        <p className="ml-10">
        ...
        <p className="ml-4 font-bold">Bond</p>
        <p className="ml-10">
        ...
        <p className="ml-4 font-bold">Dispute Center</p>
        <p className="ml-10">
        ...
        <p className="ml-4 font-bold">Feedback Loop</p>
        <p className="ml-10">
        ...
        <p className="ml-4 font-bold">Onboarding</p>
        <p className="ml-10">
        ...
        <p className="ml-4 font-bold">Versioning</p>
        <p className="ml-10">
        ...
        <p className="ml-4 font-bold">trust Governance</p>
        <p className="ml-10">
