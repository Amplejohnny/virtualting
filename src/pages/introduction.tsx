...
import { Heading, SubTopic } from "../components/docSection";

export default function IntroductionPage() {
  return (
    <>
      <Heading id="what-is-virtualting" title="What is Virtualting?">
        <p>
      ...
      <Heading id="core-principles" title="Core Principles">
        <p>
      ...
      <Heading id="use-cases" title="Use Cases">
        <p>
